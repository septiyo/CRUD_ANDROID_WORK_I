...
public class EditBukuTamu extends Activity {
	...
	private static final String url_pendaftaran_details = "http://10.2.13.160/pendaftaran/get_pendaftaran_details.php";

	// url untuk pembaharuan buku tamu
	private static final String url_update_pendaftaran = "http://10.2.13.160/pendaftaran/update_pendaftaran.php";

	// url untuk menghapus buku tamu
	private static final String url_delete_pendaftaran = "http://10.2.13.160/pendaftaran/delete_pendaftaran.php";
